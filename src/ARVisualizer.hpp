...
public:
  ...
  // @pixels image data
  void NotifyNewVideoFrame(int width, int height, const unsigned char* pixels);
  ...
  void NotifyNewVideoFrame(int width, int height, const unsigned char* pixels, float largefactor);
