...
public:
  ...
  virtual ui_element_handle AddSliderFloat2(const char* label, float min, float max, const float* values = nullptr) = 0;
  virtual ui_element_handle AddSliderFloat3(const char* label, float min, float max, const float* values = nullptr) = 0;
  virtual ui_element_handle AddSliderFloat4(const char* label, float min, float max, const float* values = nullptr) = 0;
  ...
  virtual ui_element_handle AddSliderInt2(const char* label, int min, int max, const int* values = nullptr) = 0;
  virtual ui_element_handle AddSliderInt3(const char* label, int min, int max, const int* values = nullptr) = 0;
  virtual ui_element_handle AddSliderInt4(const char* label, int min, int max, const int* values = nullptr) = 0;
  virtual ui_element_handle AddDragFloat(const char* label, float min, float max, float speed = 0.0f, float value = 0.0f) = 0;
  virtual ui_element_handle AddDragFloat2(const char* label, float min, float max, float speed = 0.0f, const float* values = nullptr) = 0;
  virtual ui_element_handle AddDragFloat3(const char* label, float min, float max, float speed = 0.0f, const float* values = nullptr) = 0;
  virtual ui_element_handle AddDragFloat4(const char* label, float min, float max, float speed = 0.0f, const float* values = nullptr) = 0;
  virtual ui_element_handle AddDragInt(const char* label, int min, int max, float speed = 0.0f, int value = 0) = 0;
  virtual ui_element_handle AddDragInt2(const char* label, int min, int max, float speed = 0.0f, const int* values = nullptr) = 0;
  virtual ui_element_handle AddDragInt3(const char* label, int min, int max, float speed = 0.0f, const int* values = nullptr) = 0;
  virtual ui_element_handle AddDragInt4(const char* label, int min, int max, float speed = 0.0f, const int* values = nullptr) = 0;
  ...
  virtual ui_element_handle AddComboBox(const char* label, const char** items, int itemsCount, int selectedItem = 0) = 0;
  ...
  virtual ui_element_handle AddColorEdit3(const char* label, float color[3]) = 0;
  virtual ui_element_handle AddColorEdit4(const char* label, float color[4]) = 0;
  ...
  virtual int GetSelectedComboBoxItem(ui_element_handle handle) const = 0;
  virtual std::string GetInputTextValue(ui_element_handle handle) const = 0;
  virtual void GetColorValues3(ui_element_handle handle, float color[3]) const = 0;
  virtual void GetColorValues4(ui_element_handle handle, float color[4]) const = 0;
